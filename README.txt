...
I used postgres in this assignment. There is one thing I want to mention, in order to pass the Junit tests you might have to run 'mvn jetty:run' before you run 'mvn clean install'. Otherwise you will run into errors like 'Error executing DDL via JDBC Statement' saying that is "Caused by: org.postgresql.util.PSQLException: ERROR: relation 'courses_students' does not exist”. 
...
--------+------------------+-------+-------
 ...
 public | courses_students | table | dhis
...
------------+--------------+-------------+-------------
          1 | John McClane | no location | no location
          2 | Jane Fonda   | no location | no location
(2 rows)
